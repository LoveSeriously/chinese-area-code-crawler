...
//        CATEGORY_LIST.add(new Category.CategoryBuilder().setCategoryCode("65"). setCategoryName("新疆维吾尔自治区").setpNames("新疆维吾尔自治区").setpId("40283f81513ec42d01513ec524150000").setpIds("0/40283f81513ec42d01513ec524150000").setIsLeaf(0).build());
    ...
    private static Request.Builder getBuilder(String parentCode) {
        ...
        requestBuilder.header("Cookie", "_trs_uv=jyr1gamz_6_ciri; __utma=207252561.1066798203.1564680696.1564680696.1564680696.1; __utmz=207252561.1564680696.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); AD_RS_COOKIE=20082854; wzws_cid=0ca75b988b8ae921bb272d940a17786f8ba359e6819f5a2eaf7910a0e5b5a5045035b36ad594ca1b942a34839e87094881016189af06a6739718de2efd7daf36");
            ...
            for (Element element : elements) {
                ...
                if ("tr".equalsIgnoreCase(element.nodeName()) &&
                    ...
                    if (!areaName.equalsIgnoreCase("市辖区") && !areaName.equalsIgnoreCase("县")) {
                        String shortAreaId = Util.getShortAreaId(areaId);
                        ...
                        if (categorys.size() == 0) {
                            // 第一个节点
                            ROOT_CATEGORY.setCategoryCode(Util.getParentCode(ROOT_CATEGORY.getCategoryCode() + "00"));
                            // 将id做为key, 检索方便
                            pidMark.put(ROOT_CATEGORY.getCategoryCode(), ROOT_CATEGORY);
                            categorys.add(ROOT_CATEGORY);

                            Category categoryByParent = Util.getCategoryByParent(pidMark, parentCode + "00");
